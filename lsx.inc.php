...
class PluginLsx
{
	...
	function next_pages()
	{
		...
		if ($prevmax > 0) {
			...
			$prevlink = '<span class="prev" style="float:left;"><a href="' . $prevhref . '">' . _('Prev ') . $count . '</a></span>';
		}
		$nextmin = max($max + 1, 0);
		...
		if ($nextmin < $maxnum) {
			...
			$nextlink = '<span class="next" style="float:right;"><a href="' . $nexthref . '">' . _('Next ') . $count . '</a></span>';
		}
		$ret = '';
